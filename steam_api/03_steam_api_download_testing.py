...
#app_list.to_csv('C:/Users/tchac/Downloads/app_list.csv', index=False)

# #instead read from stored CSV
app_list = pd.read_csv('C:/Users/tchac/Downloads/app_list.csv')
...
def get_app_data(start, stop, parser, pause):
    ...
    for index, row in app_list[start:stop].iterrows():
        ...
        # retrieve app data for a row, handled by a supplied parser, and append to list
...
def process_batches(parser, app_list, download_path, data_filename, index_filename,
    ...
    for i in range(len(batches) - 1):
        ...
        # writing the lsat index to file
...
def parse_steam_request(appid, name):
    ...
    Returns : json formatted to (dict-like)
    """
...
# pd.read_csv('C:/Users/tchac/Downloads/steam_app_data.csv').head()
...
pd.read_csv('C:/Users/tchac/Downloads/steamspy_data.csv').head()
